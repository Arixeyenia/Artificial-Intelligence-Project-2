    ...
    def __init__(self, colour):
        if (colour == "black"):
            ...
            self.TT = {
                ...
                (0, 6), (1, 6),    (3, 6), (4, 6),   (6, 6), (7, 6)])): ("MOVE", 1, (7,7), (7,6)),
                
                tuple(sort_list_of_coordinates([(0, 7), (1, 7),   (3, 7), (4, 7),   (6, 7),
                (0, 6), (1, 6),    (3, 6), (4, 6),   (6, 6), (7, 6)])): ("MOVE", 2, (7,6), (7,4)),

                tuple(sort_list_of_coordinates([(0, 7), (1, 7),   (3, 7), (4, 7),   (6, 7),
                (0, 6), (1, 6),    (3, 6), (4, 6),   (6, 6), (7,4)])): ("MOVE", 1, (7,4), (7,2))
            }
        else:
            self.TT = {
                tuple(sort_list_of_coordinates([(0, 1), (1, 1),   (3, 1), (4, 1),   (6, 1), (7, 1), 
                (0, 0), (1, 0),   (3, 0), (4, 0),   (6, 0), (7, 0)])): ("MOVE", 1, (7,0), (7,1)),

                tuple(sort_list_of_coordinates([(0, 1), (1, 1),   (3, 1), (4, 1),  (6, 1), (7, 1), 
                (0, 0), (1, 0),   (3, 0), (4, 0),   (6, 0)])): ("MOVE", 2, (7,1), (7,3)),

                tuple(sort_list_of_coordinates([(0, 1), (1, 1),   (3, 1), (4, 1),   (6, 1), (7, 3),          
                (0, 0), (1, 0),   (3, 0), (4, 0),   (6, 0)])): ("MOVE", 1, (7,3), (7,5))
            }
